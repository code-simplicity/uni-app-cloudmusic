				...
				<view class="dynamics-content flex-layout" v-for="(item, index) in eventList" :key="index">
					...
					<view class="right">
						...
						<view class="image-box" v-if="item.pics.length > 1">
							<view class="image-list" v-for="(item1, index1) in item.pics" :key="index1">
								<u-image
									border-radius="16rpx"
									width="100%"
									height="100%"
						...
						<view class="image-box-one" v-if="item.pics.length === 1">
							<view class="image-list" v-for="(item2, index2) in item.pics" :key="index2">
								<u-image
									border-radius="16rpx"
									width="100%"
									height="100%"
						...
						<view class="music" v-if="eventJson[index].song" @click="playMusic(index)">
							<view class="music-image">
								...
								<view class="play-icon">
									<u-icon name="play-right" size="30" color="#eeebee"></u-icon>
								</view>
							</view>
